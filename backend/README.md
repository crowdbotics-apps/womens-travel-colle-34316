...
## Project Structure
    ...
    ├── womens_travel_colle_34316  # Django project configurations
...
1. Clone this repo and `cd womens_travel_colle_34316`
...
2. Clone this repo and `cd womens_travel_colle_34316`
